 ...
 */
public class WaterViewTwo extends FrameLayout {
    ...
    public WaterViewTwo(@NonNull Context context) {
        this(context, null);
    }

    public WaterViewTwo(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WaterViewTwo(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
