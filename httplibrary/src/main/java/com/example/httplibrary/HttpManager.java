...
import com.example.httplibrary.client.CookieIncepter;
import com.example.httplibrary.client.LogIncepter;
...
public class HttpManager {
    ...
    private OkHttpClient getBaseOkhttpClient(long timeout, TimeUnit timeUnit) {
        ...
        Interceptor[] interceptors = {new LogIncepter(), interceptor,new CookieIncepter()};
